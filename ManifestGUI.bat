...
if exist "J:/PROV/TECHNOLOGY MANAGEMENT/Application Development/VERS/VERSCode" (
	...
	set javafx="C:/Program Files/java/javafx-sdk-17.0.0.1"
...
java --module-path %javafx%/lib --add-modules=javafx.controls,javafx.fxml -classpath %code%/Manifest/dist/* Manifest.ManifestGUI Manifest.jar %*
